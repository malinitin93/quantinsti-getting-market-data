...
#read the data
#First Contract
first_contract_data=pd.read.csv( path+"HEV20.csv", index_column=0,parse_dates=True)
#Second Contract
second_contract_data=pd.read.csv(path+"HEZ20.csv", index_column=0,parse_dates=True)
